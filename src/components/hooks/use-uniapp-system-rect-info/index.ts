...
export const useUniAppSystemRectInfo = () => {
	// 状态栏信息
	const skylineInfo = reactive<SkylineInfo>({
		issky: DEFAULT_ISSKY
	})
	...
	const getSystemRectInfo = () => {
		try {
			const uniSkylineInfo = uni.getSkylineInfoSync()
      ...
      navBarBoundingInfo.marginRight = windowWidth - navBarBoundingInfo.right
			...
			systemScreenInfo.minwidth = windowWidth>500?(375):(windowWidth),
